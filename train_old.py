...
#       "text-generation",
#       model="/home/qust521/Projects/task10/phi-4/output/phi-4_4096_epoch/checkpoint-1",
#       model_kwargs={"torch_dtype": "float16"},
#       device_map="auto",
#     )
#     generator = pipeline("text-generation", model="/home/qust521/Projects/task10/phi-4/output/phi-4_4096_epoch/checkpoint-1")
...
args = TrainingArguments(
    output_dir="./output/phi-4_4096_epoch",
...
pipeline = transformers.pipeline(
    "text-generation",
    model="./output/phi-4_4096_epoch/checkpoint-850",
